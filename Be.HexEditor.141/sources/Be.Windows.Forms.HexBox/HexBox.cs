...
namespace Be.Windows.Forms
{
    ...
    public class HexBox : Control
    {
        ...
        class KeyInterpreter : IKeyInterpreter
        {
            ...
            {
                if (_hexBox._bytePos < 1)
                    return true;

                _hexBox.SetPosition(0, 0);
            ...
            {
                if (_hexBox._bytePos >= _hexBox._byteProvider.Length - 1)
                    return true;
        ...
        public HexBox()
        {
            ...
            this._vScrollBar.Scroll += new ScrollEventHandler(VScrollBar_Scroll);
        ...
        void SetCaretPosition(Point p)
        {
            ...
            if (_recHex.Contains(p))
            {
                ...
                SetPosition(bpi.Index, bpi.CharacterPosition);
